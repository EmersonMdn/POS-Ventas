...
export * from './components/organismos/formularios/RegisterBrand';
...
export * from './components/organismos/tables/TablaMarcas';
export { default as BrandTemplate } from './components/templates/BrandTemplate';
