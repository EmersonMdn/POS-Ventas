...
export function RegisterCategories({
  ...
  const { insertCategories, updateCategorie } = useCategoriesStore();
  ...
  async function insertar(data) {
    console.log("🚀 ~ insertar ~ p.dataSelect:", dataSelect)
    console.log("🚀 ~ insertar ~ p.dataSelect:", data)
    if (accion === "Edit") {
      const p = {
      ...
      await updateCategorie(p, dataSelect.icon, file);
    } else {
      const p = {
        _name: ConvertirCapitalize(data.descripcion),
        _color: currentColor,
